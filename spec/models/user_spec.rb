...
describe User do
  ...
  describe "destroy relationship" do
    ...
    it "should destroy followerd user" do
    ...
    it "should destory follower user" do
      relationships=@user.relationships.to_a
      @user.destroy
      expect(relationships).not_to be_empty
      relationships.each do |relationship|
...
describe "when password dosen't match comfirmaiton"do
...
describe "micropost associations" do
  ...
  describe"status" do
    ...
    before do
      ...
      3.times{followed_user.microposts.create!(content: "Lorem ipusm")}
    end
